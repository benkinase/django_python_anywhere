...
class Room(models.Model):
    ...
    size=models.IntegerField(choices=ROOM_SIZES.choices(), default=ROOM_SIZES.S400)
    no_of_beds=models.IntegerField(default=1)
    capacity=models.IntegerField(default=1)
    room_type=models.CharField(max_length=32,choices=ROOM_TYPES,default='standard')
...
class Extras(models.Model):
    ...
    room=models.ForeignKey(Room, on_delete=models.CASCADE, related_name="extras", null=True, blank=True)
...
class Booking(models.Model):
    ...
    no_of_guests=models.IntegerField(choices=list(zip(range(1, 10), range(1, 10))))
